...
echo "========================================"
echo "  Failed Package Installation Script"
echo "========================================"
echo ""
...
echo "2. Verify installations: docker --version, python3 --version"
echo "3. Reboot to activate all changes: sudo reboot"
echo ""
echo "Installation log saved to: /var/log/package-install.log"
